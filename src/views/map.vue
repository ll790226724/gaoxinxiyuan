  ...
  data () {
    return {
      craneStates: {
        ...
        communityAreaStyle: {strokeColor: '#16c3c1', fillColor: '#32c5ff', fillOpacity: 0.2, strokeWeight: 3},
        communityAreaHoverStyle: {strokeColor: '#16c3c1', fillColor: '#32c5ff', fillOpacity: 0.2, strokeWeight: 3},
        ...
        comprehensiveBuildingMarkers: [],
        communityBuildingMarkers: [],
